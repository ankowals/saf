...
public class CoreCloudDirectorSteps extends BaseSteps {
    ...
    public CoreCloudDirectorSteps(SharedContext ctx) {
        super(ctx);
    }
    ...
    public void add_node_to_trusted_hosts(String node) throws Throwable {
        Log.info("* Step started add_node_to_trusted_hosts");
    ...
    public void check_that_DNS_entry_for_remote_host_was_updated(String node) throws Throwable {
        Log.info("* Step started check_that_DNS_entry_for_remote_host_was_updated");
    ...
    public void remote_host_is_accessible(String node) throws Throwable {
        Log.info("* Step started remote_host_is_accessible");
        ...
        String result = WinRSCore.executeSingleCommandOnVM("'Hostname'", node, 60);
        String returnedHostName = result.replaceAll("(\\r|\\n)", "").trim();

        if ( ! StringUtils.containsIgnoreCase(address, returnedHostName) ) {
            Log.error("host " + node + " is not accessible");
        }
    ...
    public void remote_host_set_new_MS_SQL_password_for_user_sa(String node, String password) throws Throwable {
        Log.info("* Step started remote_host_set_new_MS_SQL_password_for_user_sa");
    ...
    public void create_new_vApp(String name) throws Throwable {
        Log.info("* Step started create_new_vApp");
    ...
    public void add_new_vm_to_vApp(String name) throws Throwable {
        Log.info("* Step started add_new_vm_to_vApp");
    ...
    public void force_recustomization_for_vm(String name) throws Throwable {
        Log.info("* Step started force_recustomization_for_vm");
     ...
     */
    @When("^powerOn vm (.+)$")
    public void powerOn_vm(String name) throws Throwable {
        Log.info("* Step started powerOn_vm");
     ...
     */
    @When("^powerOff vm (.+)$")
    public void powerOff_vm(String name) throws Throwable {
        Log.info("* Step started powerOff_vm");
     ...
     */
    @Given("^reboot vm (.+)$")
    public void reboot_vm(String name) throws Throwable {
        Log.info("* Step started reboot_vm");
    ...
    public void check_vm_status(String name) throws Throwable {
        Log.info("* Step started check_vm_status");
    ...
    public void remove_vm_from_vApp(String name) throws Throwable {
        Log.info("* Step started remove_vm_from_vApp");
    ...
    public void on_remote_host_force_restart(String node) throws Throwable {
        Log.info("* Step started on_remote_host_force_restart");
    ...
    public void on_remote_host_set_default_user(String node) throws Throwable {
        Log.info("* Step started on_remote_host_set_default_user");
